...
### Download misc files
source_url = 'https://raw.github.com/lime/rails4-bootstrap-devise-cancan-omniauth/download'
...
get "#{source_url}/app/views/devise/unlocks/new.html.haml",                   'app/views/devise/unlocks/new.html.haml'
get "#{source_url}/app/views/devise/registrations/edit.html.haml",            'app/views/devise/registrations/edit.html.haml'
get "#{source_url}/app/views/devise/registrations/new.html.haml",             'app/views/devise/registrations/new.html.haml'
get "#{source_url}/app/views/devise/sessions/new.html.haml",                  'app/views/devise/sessions/new.html.haml'
get "#{source_url}/app/views/devise/passwords/edit.html.haml",                'app/views/devise/passwords/edit.html.haml'
get "#{source_url}/app/views/devise/passwords/new.html.haml",                 'app/views/devise/passwords/new.html.haml'
get "#{source_url}/app/views/devise/confirmations/new.html.haml",             'app/views/devise/confirmations/new.html.haml'
get "#{source_url}/app/views/devise/shared/_links.haml",                      'app/views/devise/shared/_links.haml'
...
get "#{source_url}/app/views/users/index.html.haml",                          'app/views/users/index.html.haml'
get "#{source_url}/app/views/users/show.html.haml",                           'app/views/users/show.html.haml'
get "#{source_url}/app/views/users/_user.html.haml",                          'app/views/users/_user.html.haml'
